...
{
	m_pPath = pPath;
    this->m_ofn.lpstrInitialDir = *m_pPath;
}
...
//	*((CFolderDialog*)((CFileDialog*)CWnd::FromHandle(hwnd))->GetDlgItem(0))->m_ofn.lpstrInitialDir = "d:\\";
...
void CFolderDialog::OnInitDone()
{
	...
	pFD->SetWindowText(_T("Seleccione un directorio"));
//    this->m_ofn.lpstrInitialDir = "c:\\";
